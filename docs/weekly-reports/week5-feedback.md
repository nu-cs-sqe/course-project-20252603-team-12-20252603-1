...
| 3 | GitHub commit history demonstrates evidence of a TDD/BDD workflow for all the non-UI code. (needed for Letter Grade C)                                       |   ✅         | Yiji edited this because the previous notes were not correct with respect to TDD. Yiji examined the commit history and confirmed that the team follows TDD correctly!                 | Project grading rubrics                                                           |
