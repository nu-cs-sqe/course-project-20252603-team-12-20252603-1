...
| 3 | GitHub commit history demonstrates evidence of a TDD/BDD workflow for all the non-UI code. (needed for Letter Grade C)                                       |   ⚠️        | It seems that for classes one test is implemented and then the logic, followed by all other corresponding tests. TDD should see all tests created initially, not retro-actively.                    | Project grading rubrics                                                           |

### Planning & Progress Evaluation
| # | Item                                                                                                                                                         |  Status   | Reviewer Notes      | Source Instructions or Resources                                                  |
|---|--------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------:|---------------------|-----------------------------------------------------------------------------------|
| 4 | The team documents every week’s planning and progress evaluation professionally. (needed for Letter Grade B)                                                 |  ✅         | Look's great!                    | Week 4 Wednesday Lecture (Lecture 08), Project grading rubrics                    |
...
| 3.3 | Task assignments are documented clearly in the management board.                                                                                             |  ❌         | I do not believe that the project managament board is being used as it should be. Please document each task/item within the project board.                    | Week 4 Wednesday Lecture (Lecture 08), Canvas assignment Project: Week 4 Guidance |

## Additional Comments
Coming back to feedback from last week regarding the project management board, I do not believe that the current board matches the course expectations. I would highly recommend documenting and assigning each feature as its own item, even if seemingly redundant. Note that as part of the project grading rubric, a letter C grade requires that "The team uses the project management board steadily and frequently ..."
