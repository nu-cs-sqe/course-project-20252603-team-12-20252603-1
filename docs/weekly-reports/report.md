...
8. [done] Didier: Added BVA and unit tests for BoardController to close PIT line and mutation gaps ([#88](https://github.com/nu-cs-sqe/course-project-20252603-team-12-20252603-1/pull/88)). Added acknowledgements to README ([#93](https://github.com/nu-cs-sqe/course-project-20252603-team-12-20252603-1/pull/93)).
...
11. [done] Matthew: Refactored castling to king-takes-rook encoding (castling moves now target the rook's square) to fix Chess960 edge cases — adjacent king/rook, king already on its destination square, and clicking the castling rook re-selecting instead of castling. Updated MoveGenerator, Board, and BoardController with TDD. ([#99](https://github.com/nu-cs-sqe/course-project-20252603-team-12-20252603-1/pull/99))
