...
|                            |⚠️     | 100% cyclomatic coverage for non-GUI and non-enum code.                                                                                                                         | There is one missing coverage that I think deserves some test cases: addPawnForwardMoves in MoveGenerator class |
