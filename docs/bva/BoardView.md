...
- **BV-TC2: Constructor_WithValidController_PreferredWidthIsBoardSizeTimesTileSize** ( :x: )
  - **Method(s) under test**: `BoardView(BoardController)`
...
- **BV-TC5: MouseClicked_AtLastPixelOfFirstTile_CallsHandleSquareClickWithFileZero** ( :x: )
  - **Method(s) under test**: `BoardMouseListener.mouseClicked`
...
- **BV-TC7: MouseClicked_AtLastPixelOfBoard_CallsHandleSquareClickWithFileSevenRankZero** ( :x: )
  - **Method(s) under test**: `BoardMouseListener.mouseClicked`
...
- **BV-TC10: MouseClicked_AtFirstPixelOfSecondTileRow_CallsHandleSquareClickWithRankSix** ( :x: )
  - **Method(s) under test**: `BoardMouseListener.mouseClicked`
